 ...
 */
@ManagedBean(name = "PerfilJava", eager = true)
public class Perfil extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(acao.equals("atualizarPerfil"))
        {
            ...
            try 
            {
                UsuarioDAO.getInstance().update(ul, u);
        ...
        {
            request.setAttribute("PerfilUsuarioLogado", (Model.Usuario) request.getSession().getAttribute("UsuarioLogado"));
            request.getRequestDispatcher("/Views/Menu/Perfil.jsp").forward(request, response);
        }
        else
        {
