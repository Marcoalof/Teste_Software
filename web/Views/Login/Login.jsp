            ...
            <table cellspacing="0" role="presentation">
                <tbody>
                    <tr>
                      ...
                      <td style="padding: 5px">
                          <button type="button" class="btn btn-success" tabindex="4" id="entrar" onClick="return valida_login(this)">Entrar <span class="glyphicon glyphicon-circle-arrow-right"/></button>
                      </td>  
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td style="padding: 5px">
                        <a style="color: #1870BB" href="http://www.ufjf.br/cursocomputacao/">Esqueceu sua senha?</a>
                      </td>
                    </tr>
                </tbody>
              </table>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <p><a class="btn btn-default" href="http://www.ufjf.br/portal/" role="button">Mais detalhes &raquo;</a></p>
        </div>
        <div class="col-md-6">
          ...
          <p><a class="btn btn-default" href="http://www.ufjf.br/cursocomputacao/" role="button">Mais detalhes &raquo;</a></p>
       </div>
      </div>
