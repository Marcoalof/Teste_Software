...
<html xmlns="http://www.w3.org/1999/xhtml" lang="pt-br" xml:lang="pt-br" >
    ...
    <body>
        ...
        <div class="cadastrosBasicos">
            ...
            <legend>Criticidade dos Projetos</legend>
            
                <div id="duracaoProjeto" class="panel panel-default">
                    <div class="panel-heading" style>
                        <a href="ControllerRedirecionar?page=/Projeto_Teste_Software/Views/Cadastros/CriticidadeProjeto/InserirEditar.jsp&acao=inserir">
                    ...
                    <table class="table" id="tbl-quality-answers">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="cp" items="${cps}">
                                <tr>
                                    <td>
                                        <a href="/Projeto_Teste_Software/Controller?classe=ControllerLogicCriticidadeProjeto&acao=editarPopular&id=${cp.id}" >
                                        ...
                                        <a href="/Projeto_Teste_Software/Controller?classe=ControllerLogicCriticidadeProjeto&acao=excluir&id=${cp.id}" >
