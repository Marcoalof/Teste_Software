...
<html>
    ...
    <body>
        ...
        <div class="cadastrosBasicosInserir">
            <form name="fInserirPraticaAgilidade" onSubmit="return salvar_Pratica()" action="/Projeto_Teste_Software/Controller?classe=ControllerLogicPraticasAgeis&acao=inserir" method="POST" >
                <fieldset>
                    <legend>Cadastro de Prática Ágil</legend>
                    <fieldset class="form-group">
                        ...
                        <textarea rows="3" class="form-control" id="descricao" name="descricao"  maxlength="1000" placeholder="Insira a descrição da prática " ></textarea>
                        <br>
                        <label for="nome">Pertinência (%)</label>
                        <input type="number" min="0" max="100" step="any" class="form-control" id="pertinencia" name="pertinencia" placeholder="Insira o valor da Pertinência ">
                        <p>Informe apenas números. Ex.: 54,23</p>
                        <label for="nome">Relevância (%)</label>
                        <input type="number" min="0" max="100" step="any" class="form-control" id="relevancia" name="relevancia" placeholder="Insira o valor da Relevância " >
                        <p>Informe apenas números. Ex.: 54,23</p>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div id="dual-list-box-employees" class="form-group row">
                            <div class="col-md-5">
                                ...
                                <select id="listOrigem" name="listOrigem" class="unselected form-control" style="height: 200px; width: 100%;" multiple="multiple">
 ...
 <!--                               <button type="button" class="btn btn-default col-md-8 col-md-offset-2 atl" data-type="atl" style="margin-bottom: 10px;">
                            ...
                            <div class="col-md-5">
                               ...
                               <select id="listDestino" name="listDestino" class="selected form-control" style="height: 200px; width: 100%;" multiple="">
                               </select>
                            </div>
                        </div>
                     </fieldset>
