 ...
 */
function salvar_tamanho_equipe(action)
{    
    var acao = "";
    var url = "";
    var title = ""; 
    ...
    if(document.getElementById("nome").value.length == 0 || document.getElementById("peso").value.length == 0)
    {
        ...
        {
            msg = msg + "\n" + " <li> Campo Nome da Faixa de Tamanho Equipe é obrigatório; </li> ";
        }
        
        if(document.getElementById("peso").value.length == 0)
        {
            msg = msg + "\n" + " <li> Campo Peso associado a Faixa de Tamanho da Equipe é obrigatório; </li> ";
        }
    ...
    $.ajax(
    {
        ...
        success: function (response) 
        {
            if(response == true.toString())
            {
                ...
                msg = "<h4> Já existe outra Faixa de Tamanho da Equipe com o mesmo Peso informado </h4> <ol type='1' >";
                executaModal(modalAlerta, title, msg)
                retorno = "false";
            }
