...
{    
    ...
    if(document.getElementById("nome").value.length == 0 || document.getElementById("peso").value.length == 0)
    {
        ...
        {
            msg = msg + "\n" + " <li> Campo Nome do Indicador de Complexidade do Problema é obrigatório; </li> ";
        }
        
        if(document.getElementById("peso").value.length == 0)
        {
            msg = msg + "\n" + " <li> Campo Peso do Indicador de Complexidade do Problema é obrigatório; </li> ";
        }
    ...
    $.ajax(
    {
        ...
        success: function (response) 
        {
            if(response == true.toString())
            {
                ...
                msg = "<h4> Já existe outro Indicador de Complexidade do Problema com o mesmo Peso informado </h4> <ol type='1' >";
                executaModal(modalAlerta, title, msg)
                retorno = "false";
            }
