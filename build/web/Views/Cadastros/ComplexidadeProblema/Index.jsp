...
<html xmlns="http://www.w3.org/1999/xhtml" lang="pt-br" xml:lang="pt-br">
    ...
    <body>
        ...
        <div class="cadastrosBasicos">
            ...
            <legend>Indicador de Complexidade do Problema</legend>
            
                <div id="cicloVida" class="panel panel-default">
                    <div class="panel-heading" style>
                        <a href="ControllerRedirecionar?page=/Projeto_Teste_Software/Views/Cadastros/ComplexidadeProblema/InserirEditar.jsp&acao=inserir">
                    ...
                    <table class="table" id="tbl-quality-answers">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="cp" items="${cps}">
                                <tr>
                                    <td>
                                        <a href="/Projeto_Teste_Software/Controller?classe=ControllerLogicComplexidadeProblema&acao=editarPopular&id=${cp.id}" >
                                        ...
                                        <a href="/Projeto_Teste_Software/Controller?classe=ControllerLogicComplexidadeProblema&acao=excluir&id=${cp.id}" >
                                    ...
                                    <td><c:out value="${cp.nome}"/></td>
                                    <td><c:out value="${cp.peso}"/></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
